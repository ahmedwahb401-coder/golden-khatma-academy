...
export const metadata: Metadata = {
  ...
  description:
    "إشراف محفّظات متخصصات لتحفيظ ومراجعة القرآن الكريم للنساء والفتيات أونلاين.",
};

export default async function WomenSectionPage() {
      ...
      <section id="teachers" className="max-w-6xl mx-auto px-5 py-20">
        <div className="text-center mb-12">
          ...
          <p className="opacity-70">
            نخبة من المحفّظات المعتمدات، بخبرة طويلة في تحفيظ النساء والفتيات.
          </p>
        </div>
